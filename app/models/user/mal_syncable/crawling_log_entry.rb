class User
  module MALSyncable
    class CrawlingLogEntry < ApplicationRecord
      ...
      before_create :calculate_data_checksum, if: :success?
      after_create :copy_crawled_data_to_user, if: :success?
      ...
      def copy_crawled_data_to_user
        Instrumentation.instrument(title: "#{self.class.name}#copy_crawled_data_to_user") do
          transaction do
